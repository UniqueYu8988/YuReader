...
2. **☀️ 09:00 · 深度研读与理论靶向精读**
   - **带着问题进入正文**：打开《牙体牙髓病学》，拒绝催眠通读。点击顶部呼出「带着问题读」考点抽屉，10 道高频章节考题（名解 6 + 论述 4）先导锚定在大脑中。
   - **沉浸静默心流**：左上角 40px 徽标激活 6px 暖色慢呼吸微点，微光环以 1 秒为步长随有效阅读平滑推进医学 2.0h 阅读目标。
   - **小节笔记与侧边栏 AI 追问**：右下角常驻操作栏一键唤出「小节笔记抽屉」沉淀机理图解，点击 `obsidian://open` 原生直达本地独立笔记；读毕回看抽屉展开权威标准答案印证，并一键格式化复制给侧边栏大模型（Gemini / Claude）进行临床病例延伸追问。
