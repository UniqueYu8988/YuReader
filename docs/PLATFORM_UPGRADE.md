...
> 历史阶段说明（2026-09-02）：本文是 0.9 阶段的已完成执行记录，不再是当前统一学习系统的设计权威。当前目标与阶段门槛以 [`docs/learning-system-redesign/README.md`](learning-system-redesign/README.md) 及其中的 01–06 编号文档为准；本文中“练习不参与章节笔记与复习”的旧边界已被新方案替代。本文关于本地优先、稳定知识位置、原始资料保护和回退的约束继续有效。本文件保留，不删除。
